            ...
            <b-container fluid>
                <b-form @submit="guardar()" @reset="cerrar()">
                    <b-form-group id="input-group-0" label="Nombre Usuario:" label-for="input-0">
                        <b-form-input id="input-0" v-model="form.nombre" type="text" placeholder="Ingreese Nombre del Usuario" requiere></b-form-input>
                    </b-form-group>

                    <b-form-group id="input-group-1" label="Usuario:" label-for="input-1">
                        <b-form-input id="input-1" v-model="form.usuario" type="text" placeholder="Ingreese Usuario" requiere></b-form-input>
                    </b-form-group>
                    
                    <b-form-group id="input-group-2" label="Clave:" label-for="input-2">
                        <b-form-input id="input-2" v-model="form.contra" placeholder="Ingreese Clave" requiere></b-form-input>
                    </b-form-group>
                    
                    <b-form-group id="input-group-3" label="Clave:" label-for="input-3">
                        <b-form-select id="input-3" v-model="form.tipo" :options="tipos" requiere></b-form-select>
                    </b-form-group>
                </b-form>
            </b-container>
